...
ActiveRecord::Schema.define(version: 20140717121702) do
  ...
  add_foreign_key "demo_order_items", "demo_orders", column: "order_id", primary_key: "order_id", name: "demo_order_items_fk", dependent: :delete
  add_foreign_key "demo_order_items", "demo_product_info", column: "product_id", primary_key: "product_id", name: "demo_order_items_product_id_fk", dependent: :delete
  ...
  add_foreign_key "emp", "dept", column: "deptno", primary_key: "deptno", name: "sys_c007154"
  add_foreign_key "emp", "emp", column: "mgr", primary_key: "empno", name: "sys_c007153"
